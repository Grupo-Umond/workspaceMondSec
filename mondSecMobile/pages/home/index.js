  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.mapContainer}>
         <MapaService ref={mapaRef} style={styles.mapImage} />

         <View style={styles.navigationContainer}>
          <Pressable style={({ pressed }) => [styles.navButton, { opacity: pressed ? 0.6 : 1 }]} 
...
// Aqui você mantém os estilos que já tinha
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: '#E6F0FA' },
  header: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 15, backgroundColor: '#FFFFFF', borderBottomWidth: 1, borderBottomColor: '#DDDDDD' },
  headerText: { fontSize: 18, fontWeight: 'bold', color: '#003366' },
  settingsButton: { padding: 8 },
  searchContainer: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#FFFFFF', borderRadius: 8, margin: 10, paddingHorizontal: 10, shadowColor: '#000', shadowOpacity: 0.1, shadowRadius: 4 },
  searchInput: { flex: 1, height: 40, color: '#333' },
  searchButton: { padding: 8 },
  mapContainer: { flex: 1, margin: 18, borderRadius: 12, overflow: 'hidden', width: '90%', alignItems: 'center' },
  mapImage: { width: '100%', flex: 1 },
  navigationContainer: { position: 'absolute', bottom: 24, left: 16, right: 16, flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center', backgroundColor: 'rgba(0, 51, 102, 0.9)', borderRadius: 28, paddingVertical: 8, paddingHorizontal: 10, shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.3, shadowRadius: 8, elevation: 10 },
  navButton: { alignItems: 'center', justifyContent: 'center', paddingVertical: 8, paddingHorizontal: 16, borderRadius: 20 },
  centralButton: { alignItems: 'center', justifyContent: 'center', width: 60, height: 60, borderRadius: 30, backgroundColor: '#FFF', marginTop: -30, shadowColor: '#000', shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.3, shadowRadius: 4, elevation: 5 },
  navButtonText: { color: '#FFFFFF', fontSize: 12, marginTop: 4, fontWeight: '500' },
  modalContainer: { flex: 1, backgroundColor: 'rgba(0,0,0,0.3)', justifyContent: 'center', alignItems: 'center' },
  modalContent: { backgroundColor: '#FFFFFF', padding: 20, borderRadius: 10, width: '90%', alignItems: 'center' },
  modalTitle: { fontSize: 20, fontWeight: 'bold', marginBottom: 10, color: '#003366' },
  modalText: { textAlign: 'center', marginBottom: 20, color: '#333' },
  modalButton: { color: '#007BFF', marginTop: 10, fontWeight: 'bold' },
});
